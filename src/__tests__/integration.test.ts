...
const ESCROW_CONTRACT_ID = cleanEnvVar(process.env.NEXT_PUBLIC_ESCROW_CONTRACT_ID) || 'CA3DCO4OZEWQR2GKIBU4W3OIC3U7MPZDI6TWL7MAZE2S2G6KA55UUT34';
const DISPUTE_CONTRACT_ID = cleanEnvVar(process.env.NEXT_PUBLIC_DISPUTE_CONTRACT_ID) || 'CA5MT45EXTOJH3UPKMYWW2WHPWMXOZ6RALRM5JUQNMSWJZRNT2WF3YX3';
