...
const ESCROW_CONTRACT_ID = cleanEnvVar(process.env.NEXT_PUBLIC_ESCROW_CONTRACT_ID) || 'CAUQOF5U6PUWNBZYWUAWBMYXQNPBXUQQWH3EHO6GQMUFKKNFQBWKXEUD';
const DISPUTE_CONTRACT_ID = cleanEnvVar(process.env.NEXT_PUBLIC_DISPUTE_CONTRACT_ID) || 'CARBWEU5IF6Q4DJQHNJJOLFG57WXPWIIU5KUPMN2VRADO6GUSRAGKG3W';
