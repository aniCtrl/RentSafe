...
export const DEFAULT_ESCROW_ID = cleanEnvVar(process.env.NEXT_PUBLIC_ESCROW_CONTRACT_ID) || 'CAUQOF5U6PUWNBZYWUAWBMYXQNPBXUQQWH3EHO6GQMUFKKNFQBWKXEUD';
export const DEFAULT_DISPUTE_ID = cleanEnvVar(process.env.NEXT_PUBLIC_DISPUTE_CONTRACT_ID) || 'CARBWEU5IF6Q4DJQHNJJOLFG57WXPWIIU5KUPMN2VRADO6GUSRAGKG3W';
export const DEFAULT_PLATFORM_ADMIN_ID = cleanEnvVar(process.env.NEXT_PUBLIC_PLATFORM_ADMIN_ADDRESS) || 'GCLSFD4ILBZCVMDY5R5ZGO6VEKQEHIKZATGOO4MX35DBPQ4QQ2SZR2NV';
...
export const DEFAULT_DISPUTE_WASM_HASH = cleanEnvVar(process.env.NEXT_PUBLIC_DISPUTE_WASM_HASH) || 'c6c32aca57e5993f66ce1fc585a495457d3c273b54d58977d8e84d679051966a';
