...
export const DEFAULT_ESCROW_ID = cleanEnvVar(process.env.NEXT_PUBLIC_ESCROW_CONTRACT_ID) || 'CA3DCO4OZEWQR2GKIBU4W3OIC3U7MPZDI6TWL7MAZE2S2G6KA55UUT34';
export const DEFAULT_DISPUTE_ID = cleanEnvVar(process.env.NEXT_PUBLIC_DISPUTE_CONTRACT_ID) || 'CA5MT45EXTOJH3UPKMYWW2WHPWMXOZ6RALRM5JUQNMSWJZRNT2WF3YX3';
